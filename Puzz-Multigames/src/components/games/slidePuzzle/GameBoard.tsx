      ...
      <div className="relative flex flex-col justify-center gap-4 lg:flex-row-reverse">
        <div className="flex w-full flex-col justify-between gap-2 lg:w-auto lg:flex-col lg:justify-start">
          <div className="flex w-full justify-end">
            ...
            >
              <InformationCircleIcon className="h-8 w-8 stroke-zinc-900 dark:stroke-cyan-400" />
            </button>
            <PuzzleHowToPlay
          ...
          <div className="flex w-full justify-between gap-2 lg:flex-col">
            <div className="flex w-full flex-row gap-2 md:w-auto lg:flex-col">
              <div className="inline rounded-md bg-cyan-500/10 px-2 py-1 text-cyan-600 ring-1 ring-cyan-600 dark:bg-cyan-500/10 dark:text-cyan-300 dark:ring-1 dark:ring-inset dark:ring-cyan-500/30 md:px-4 lg:w-full">
                <span className="text-xs sm:text-base">Movimentos</span>
            ...
            <div className="flex h-min gap-2 lg:flex-1 lg:flex-col">
              <button
                className="rounded-md bg-zinc-900 p-2 shadow-sm transition-colors duration-100 ease-in hover:bg-zinc-700 dark:bg-cyan-500 dark:ring-1 dark:ring-inset dark:ring-cyan-500/20 dark:hover:bg-cyan-400 dark:hover:ring-cyan-400 sm:px-4 lg:w-full"
                aria-label="ver quebra-cabeça"
              ...
              <p className="mb-1 text-sm text-gray-500">
                {`${
                  boardData.currentMove < boardData.highscore
                    ? "Novo Recorde"
                    : "Pontuação"
                } para quadro ${boardData.size}x${boardData.size}`}
              </p>
